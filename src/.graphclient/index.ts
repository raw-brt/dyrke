...
export type Account_orderBy = "id" | "address" | "profiles" | "following";
...
export type Creator_orderBy = "id" | "address" | "isWhitelisted" | "lastUpdated";
...
export type Follow_orderBy = "id" | "fromProfile" | "toProfile" | "timestamp";
...
> = ResolversObject<{
  ...
  profiles?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<AccountprofilesArgs, "skip" | "first">
  >;
  following?: Resolver<
    Array<ResolversTypes["Profile"]>,
    ParentType,
    ContextType,
    RequireFields<AccountfollowingArgs, "skip" | "first">
  >;
...
> = ResolversObject<{
  ...
  toProfile?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<FollowtoProfileArgs, "skip" | "first">
  >;
  timestamp?: Resolver<ResolversTypes["BigInt"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
> = ResolversObject<{
  ...
  comments?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<ProfilecommentsArgs, "skip" | "first">
  >;
  posts?: Resolver<
    Maybe<Array<ResolversTypes["Post"]>>,
    ParentType,
    ContextType,
    RequireFields<ProfilepostsArgs, "skip" | "first">
  >;
  mirrors?: Resolver<
    Maybe<Array<ResolversTypes["Mirror"]>>,
    ParentType,
    ContextType,
    RequireFields<ProfilemirrorsArgs, "skip" | "first">
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
> = ResolversObject<{
  stat?: Resolver<
    Maybe<ResolversTypes["Stat"]>,
    ParentType,
    ContextType,
    RequireFields<QuerystatArgs, "id" | "subgraphError">
  >;
  stats?: Resolver<
    Array<ResolversTypes["Stat"]>,
    ParentType,
    ContextType,
    RequireFields<QuerystatsArgs, "skip" | "first" | "subgraphError">
  >;
  profile?: Resolver<
    Maybe<ResolversTypes["Profile"]>,
    ParentType,
    ContextType,
    RequireFields<QueryprofileArgs, "id" | "subgraphError">
  >;
  profiles?: Resolver<
    Array<ResolversTypes["Profile"]>,
    ParentType,
    ContextType,
    RequireFields<QueryprofilesArgs, "skip" | "first" | "subgraphError">
  >;
  account?: Resolver<
  ...
  creators?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QuerycreatorsArgs, "skip" | "first" | "subgraphError">
  >;
  post?: Resolver<
    Maybe<ResolversTypes["Post"]>,
    ParentType,
    ContextType,
    RequireFields<QuerypostArgs, "id" | "subgraphError">
  >;
  posts?: Resolver<
    Array<ResolversTypes["Post"]>,
    ParentType,
    ContextType,
    RequireFields<QuerypostsArgs, "skip" | "first" | "subgraphError">
  >;
  mirror?: Resolver<
    Maybe<ResolversTypes["Mirror"]>,
    ParentType,
    ContextType,
    RequireFields<QuerymirrorArgs, "id" | "subgraphError">
  >;
  mirrors?: Resolver<
    Array<ResolversTypes["Mirror"]>,
    ParentType,
    ContextType,
    RequireFields<QuerymirrorsArgs, "skip" | "first" | "subgraphError">
  >;
  comment?: Resolver<
    Maybe<ResolversTypes["Comment"]>,
    ParentType,
    ContextType,
    RequireFields<QuerycommentArgs, "id" | "subgraphError">
  >;
  comments?: Resolver<
    Array<ResolversTypes["Comment"]>,
    ParentType,
    ContextType,
    RequireFields<QuerycommentsArgs, "skip" | "first" | "subgraphError">
  >;
  follow?: Resolver<
    Maybe<ResolversTypes["Follow"]>,
    ParentType,
    ContextType,
    RequireFields<QueryfollowArgs, "id" | "subgraphError">
  >;
  follows?: Resolver<
    Array<ResolversTypes["Follow"]>,
    ParentType,
    ContextType,
    RequireFields<QueryfollowsArgs, "skip" | "first" | "subgraphError">
  >;
  publication?: Resolver<
    Maybe<ResolversTypes["Publication"]>,
    ParentType,
    ContextType,
    RequireFields<QuerypublicationArgs, "id" | "subgraphError">
  >;
  publications?: Resolver<
    Array<ResolversTypes["Publication"]>,
    ParentType,
    ContextType,
    RequireFields<QuerypublicationsArgs, "skip" | "first" | "subgraphError">
  >;
  _meta?: Resolver<
...
> = ResolversObject<{
  stat?: SubscriptionResolver<
    Maybe<ResolversTypes["Stat"]>,
    "stat",
    ParentType,
    ContextType,
    RequireFields<SubscriptionstatArgs, "id" | "subgraphError">
  >;
  stats?: SubscriptionResolver<
    Array<ResolversTypes["Stat"]>,
    "stats",
    ParentType,
    ContextType,
    RequireFields<SubscriptionstatsArgs, "skip" | "first" | "subgraphError">
  >;
  profile?: SubscriptionResolver<
    Maybe<ResolversTypes["Profile"]>,
    "profile",
    ParentType,
    ContextType,
    RequireFields<SubscriptionprofileArgs, "id" | "subgraphError">
  >;
  profiles?: SubscriptionResolver<
    Array<ResolversTypes["Profile"]>,
    "profiles",
    ParentType,
    ContextType,
    RequireFields<SubscriptionprofilesArgs, "skip" | "first" | "subgraphError">
  >;
  ...
  creators?: SubscriptionResolver<
    ...
    ParentType,
    ContextType,
    RequireFields<SubscriptioncreatorsArgs, "skip" | "first" | "subgraphError">
  >;
  post?: SubscriptionResolver<
    Maybe<ResolversTypes["Post"]>,
    "post",
    ParentType,
    ContextType,
    RequireFields<SubscriptionpostArgs, "id" | "subgraphError">
  >;
  posts?: SubscriptionResolver<
    Array<ResolversTypes["Post"]>,
    "posts",
    ParentType,
    ContextType,
    RequireFields<SubscriptionpostsArgs, "skip" | "first" | "subgraphError">
  >;
  mirror?: SubscriptionResolver<
    Maybe<ResolversTypes["Mirror"]>,
    "mirror",
    ParentType,
    ContextType,
    RequireFields<SubscriptionmirrorArgs, "id" | "subgraphError">
  >;
  mirrors?: SubscriptionResolver<
    Array<ResolversTypes["Mirror"]>,
    "mirrors",
    ParentType,
    ContextType,
    RequireFields<SubscriptionmirrorsArgs, "skip" | "first" | "subgraphError">
  >;
  comment?: SubscriptionResolver<
    ...
    ParentType,
    ContextType,
    RequireFields<SubscriptioncommentArgs, "id" | "subgraphError">
  >;
  comments?: SubscriptionResolver<
    ...
    ParentType,
    ContextType,
    RequireFields<SubscriptioncommentsArgs, "skip" | "first" | "subgraphError">
  >;
  follow?: SubscriptionResolver<
    Maybe<ResolversTypes["Follow"]>,
    "follow",
    ParentType,
    ContextType,
    RequireFields<SubscriptionfollowArgs, "id" | "subgraphError">
  >;
  follows?: SubscriptionResolver<
    ...
    ParentType,
    ContextType,
    RequireFields<SubscriptionfollowsArgs, "skip" | "first" | "subgraphError">
  >;
  publication?: SubscriptionResolver<
    Maybe<ResolversTypes["Publication"]>,
    "publication",
    ParentType,
    ContextType,
    RequireFields<SubscriptionpublicationArgs, "id" | "subgraphError">
  >;
  publications?: SubscriptionResolver<
    Array<ResolversTypes["Publication"]>,
    "publications",
    ParentType,
    ContextType,
    RequireFields<SubscriptionpublicationsArgs, "skip" | "first" | "subgraphError">
  >;
...
export async function getMeshOptions(): Promise<GetMeshOptions> {
  ...
  return {
    ...
    get documents() {
      return [
        {
          document: GetCommentsByIntervalDocument,
          get rawSDL() {
            return printWithCache(GetCommentsByIntervalDocument);
          },
          location: "GetCommentsByIntervalDocument.graphql",
        },
        {
...
export type GetCommentsByIntervalQueryVariables = Exact<{
  first?: InputMaybe<Scalars["Int"]>;
  skip?: InputMaybe<Scalars["Int"]>;
  handle?: InputMaybe<Scalars["String"]>;
...
export type GetCommentsByIntervalQuery = { comments: Array<Pick<Comment, "pubId" | "timestamp">> };
...
export const GetCommentsByIntervalDocument = gql`
  query GetCommentsByInterval(
    $first: Int = 1000
    $skip: Int = 0
    $handle: String
    $gt: BigInt
...
` as unknown as DocumentNode<GetCommentsByIntervalQuery, GetCommentsByIntervalQueryVariables>;
export const GetFollowersByIntervalDocument = gql`
  query GetFollowersByInterval(
    $first: Int = 1000
    $skip: Int = 0
    $id: ID!
    $gt: BigInt
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    GetCommentsByInterval(
      variables?: GetCommentsByIntervalQueryVariables,
      options?: C,
    ): Promise<GetCommentsByIntervalQuery> {
      return requester<GetCommentsByIntervalQuery, GetCommentsByIntervalQueryVariables>(
        GetCommentsByIntervalDocument,
        variables,
        options,
      ) as Promise<GetCommentsByIntervalQuery>;
    },
    GetFollowersByInterval(
      variables: GetFollowersByIntervalQueryVariables,
      options?: C,
    ): Promise<GetFollowersByIntervalQuery> {
      return requester<GetFollowersByIntervalQuery, GetFollowersByIntervalQueryVariables>(
        GetFollowersByIntervalDocument,
        variables,
        options,
      ) as Promise<GetFollowersByIntervalQuery>;
    },
    GetPostsByInterval(
      variables?: GetPostsByIntervalQueryVariables,
      options?: C,
    ): Promise<GetPostsByIntervalQuery> {
      return requester<GetPostsByIntervalQuery, GetPostsByIntervalQueryVariables>(
        GetPostsByIntervalDocument,
        variables,
        options,
      ) as Promise<GetPostsByIntervalQuery>;
    },
  };
}

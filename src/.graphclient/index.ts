...
import type { LensSubgraphTypes } from './sources/lens-subgraph/types';
...
export type ResolversTypes = ResolversObject<{
  ...
  FollowNFTTransferred: ResolverTypeWrapper<FollowNFTTransferred>;
  FollowNFTTransferred_filter: FollowNFTTransferred_filter;
  FollowNFTTransferred_orderBy: FollowNFTTransferred_orderBy;
...
export type ResolversParentTypes = ResolversObject<{
  ...
  Float: Scalars['Float'];
  Follow: Follow;
  FollowNFTTransferred: FollowNFTTransferred;
  FollowNFTTransferred_filter: FollowNFTTransferred_filter;
  Follow_filter: Follow_filter;
  ID: Scalars['ID'];
  Int: Scalars['Int'];
...
export type AccountResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['Account'] = ResolversParentTypes['Account']> = ResolversObject<{
  ...
  profilesIds?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
  profiles?: Resolver<Maybe<Array<ResolversTypes['Profile']>>, ParentType, ContextType, RequireFields<AccountprofilesArgs, 'skip' | 'first'>>;
  following?: Resolver<Array<ResolversTypes['Profile']>, ParentType, ContextType, RequireFields<AccountfollowingArgs, 'skip' | 'first'>>;
  totalFollowings?: Resolver<ResolversTypes['BigInt'], ParentType, ContextType>;
...
export type FollowResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['Follow'] = ResolversParentTypes['Follow']> = ResolversObject<{
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  fromAccount?: Resolver<Maybe<ResolversTypes['Account']>, ParentType, ContextType>;
  fromProfileSTR?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type FollowNFTTransferredResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['FollowNFTTransferred'] = ResolversParentTypes['FollowNFTTransferred']> = ResolversObject<{
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  profileId?: Resolver<Maybe<ResolversTypes['BigInt']>, ParentType, ContextType>;
  followNFTID?: Resolver<Maybe<ResolversTypes['BigInt']>, ParentType, ContextType>;
...
export type ProfileResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['Profile'] = ResolversParentTypes['Profile']> = ResolversObject<{
  ...
  totalFollowings?: Resolver<ResolversTypes['BigInt'], ParentType, ContextType>;
  followers?: Resolver<Array<ResolversTypes['Account']>, ParentType, ContextType, RequireFields<ProfilefollowersArgs, 'skip' | 'first'>>;
  followings?: Resolver<Array<ResolversTypes['Profile']>, ParentType, ContextType, RequireFields<ProfilefollowingsArgs, 'skip' | 'first'>>;
...
export type QueryResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  ...
  followNFTTransferred?: Resolver<Maybe<ResolversTypes['FollowNFTTransferred']>, ParentType, ContextType, RequireFields<QueryfollowNFTTransferredArgs, 'id' | 'subgraphError'>>;
  followNFTTransferreds?: Resolver<Array<ResolversTypes['FollowNFTTransferred']>, ParentType, ContextType, RequireFields<QueryfollowNFTTransferredsArgs, 'skip' | 'first' | 'subgraphError'>>;
...
export type SubscriptionResolvers<ContextType = MeshContext, ParentType extends ResolversParentTypes['Subscription'] = ResolversParentTypes['Subscription']> = ResolversObject<{
  ...
  followNFTTransferred?: SubscriptionResolver<Maybe<ResolversTypes['FollowNFTTransferred']>, "followNFTTransferred", ParentType, ContextType, RequireFields<SubscriptionfollowNFTTransferredArgs, 'id' | 'subgraphError'>>;
  followNFTTransferreds?: SubscriptionResolver<Array<ResolversTypes['FollowNFTTransferred']>, "followNFTTransferreds", ParentType, ContextType, RequireFields<SubscriptionfollowNFTTransferredsArgs, 'skip' | 'first' | 'subgraphError'>>;
...
export type Resolvers<ContextType = MeshContext> = ResolversObject<{
  ...
  FollowNFTTransferred?: FollowNFTTransferredResolvers<ContextType>;
...
export type MeshContext = LensSubgraphTypes.Context & BaseMeshContext;
...
const importFn: ImportFn = <T>(moduleId: string) => {
  ...
  switch(relativeModuleId) {
    case ".graphclient/sources/lens-subgraph/introspectionSchema":
      return import("./sources/lens-subgraph/introspectionSchema") as T;
...
const lensSubgraphTransforms = [];
const additionalTypeDefs = [] as any[];
const lensSubgraphHandler = new GraphqlHandler({
              name: "lens-subgraph",
              config: {"endpoint":"https://api.thegraph.com/subgraphs/name/rtomas/lens-subgraph"},
              baseDir,
              cache,
              pubsub,
              store: sourcesStore.child("lens-subgraph"),
              logger: logger.child("lens-subgraph"),
              importFn,
            });
sources[0] = {
          name: 'lens-subgraph',
          handler: lensSubgraphHandler,
          transforms: lensSubgraphTransforms
        }
  ...
  return {
    ...
    get documents() {
      return [
      {
        ...
        get rawSDL() {
          return printWithCache(TestQueryDocument);
        },
        location: 'TestQueryDocument.graphql'
      }
    ];
    },
    fetchFn,
...
export type TestQueryQuery = { publications: Array<Pick<Comment, 'id' | 'timestamp'> | Pick<Mirror, 'id' | 'timestamp'> | Pick<Post, 'id' | 'timestamp'>> };


export const TestQueryDocument = gql`
    query TestQuery {
  publications(where: {fromProfile: "5", timestamp_gte: "1661176262"}) {
    id
    timestamp
  }
}
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    TestQuery(variables?: TestQueryQueryVariables, options?: C): Promise<TestQueryQuery> {
      return requester<TestQueryQuery, TestQueryQueryVariables>(TestQueryDocument, variables, options) as Promise<TestQueryQuery>;
    }
  };
}

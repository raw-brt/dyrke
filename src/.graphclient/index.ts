  ...
  return {
    ...
    get documents() {
      return [
      {
        ...
        document: GetMirrorsByIntervalDocument,
        get rawSDL() {
          return printWithCache(GetMirrorsByIntervalDocument);
        },
        location: 'GetMirrorsByIntervalDocument.graphql'
      },{
...
export type GetCommentsByIntervalQuery = { comments: Array<Pick<Comment, 'id' | 'timestamp'>> };
...
export type GetMirrorsByIntervalQueryVariables = Exact<{
  first?: InputMaybe<Scalars['Int']>;
  skip?: InputMaybe<Scalars['Int']>;
  id?: InputMaybe<Scalars['BigInt']>;
  gte?: InputMaybe<Scalars['BigInt']>;
...
export type GetMirrorsByIntervalQuery = { mirrors: Array<Pick<Mirror, 'id' | 'timestamp'>> };
...
export const GetCommentsByIntervalDocument = gql`
    query GetCommentsByInterval($first: Int = 1000, $skip: Int = 0, $id: BigInt, $gte: BigInt, $lte: BigInt, $lastID: ID = "") {
  comments(
    first: $first
    skip: $skip
    where: {profileIdPointed: $id, timestamp_gte: $gte, timestamp_lte: $lte, id_gt: $lastID}
    orderBy: id
    orderDirection: asc
  ) {
    id
...
export const GetFollowersByIntervalDocument = gql`
    query GetFollowersByInterval($first: Int = 1000, $skip: Int = 0, $id: ID!, $gte: BigInt, $lte: BigInt, $lastID: ID = "") {
  follows(
    first: $first
    skip: $skip
    where: {toProfile_: {id: $id}, timestamp_gte: $gte, timestamp_lte: $lte, id_gt: $lastID}
    orderBy: id
    orderDirection: asc
  ) {
    timestamp
...
export const GetMirrorsByIntervalDocument = gql`
    query GetMirrorsByInterval($first: Int = 1000, $skip: Int = 0, $id: BigInt, $gte: BigInt, $lte: BigInt, $lastID: ID = "") {
  mirrors(
    first: $first
    skip: $skip
    where: {profileIdPointed: $id, timestamp_gte: $gte, timestamp_lte: $lte, id_gt: $lastID}
    ...
    ` as unknown as DocumentNode<GetMirrorsByIntervalQuery, GetMirrorsByIntervalQueryVariables>;
export const GetPostsByIntervalDocument = gql`
    query GetPostsByInterval($first: Int = 1000, $skip: Int = 0, $handle: String, $gte: BigInt, $lte: BigInt, $lastPubId: BigInt = 0) {
  posts(
    first: $first
    skip: $skip
    where: {fromProfile_: {handle: $handle}, timestamp_gte: $gte, timestamp_lte: $lte, pubId_gt: $lastPubId}
    orderBy: pubId
    orderDirection: asc
  ) {
    pubId
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    GetCommentsByInterval(variables?: GetCommentsByIntervalQueryVariables, options?: C): Promise<GetCommentsByIntervalQuery> {
      return requester<GetCommentsByIntervalQuery, GetCommentsByIntervalQueryVariables>(GetCommentsByIntervalDocument, variables, options) as Promise<GetCommentsByIntervalQuery>;
    },
    ...
    GetMirrorsByInterval(variables?: GetMirrorsByIntervalQueryVariables, options?: C): Promise<GetMirrorsByIntervalQuery> {
      return requester<GetMirrorsByIntervalQuery, GetMirrorsByIntervalQueryVariables>(GetMirrorsByIntervalDocument, variables, options) as Promise<GetMirrorsByIntervalQuery>;
    },

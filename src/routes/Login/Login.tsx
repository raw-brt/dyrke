...
export const Login: FC = () => {
  ...
  return (
    <section className='w-auto h-auto flex flex-col justify-start items-center p-10'>
                ...
                (
                  ...
                  <div className='text-sm text-gray-100 p-5'>
                    ...
                    {/* Prompt to claim handle */}
                    {
                      chain?.id === CHAIN_ID
                        ? 
                          <Button className="flex item-center" size="lg" icon={<img src={LensIcon} className='mr-1 w-5 h-5 text-gray-900' alt='Lens Isotype' />}>
      ...
      <p className="text-base mt-10 text-neutral-100">Don&apos;t have a Lens profile? <a href={LENS_HANDLE_CLAIM} target="__blank" rel="noopener noreferrer" className="text-primary-500">Click here to claim yours.</a></p>
    </section>
  );
};
